    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/uudon/kotlinandroidtest/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/uudon/kotlinandroidtest.git")
                    developerConnection.set("scm:git:ssh://github.com/uudon/kotlinandroidtest.git")
                    url.set("https://github.com/uudon/kotlinandroidtest/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/uudon/kotlinandroidtest/issues")
                }
            }
        }
    }
